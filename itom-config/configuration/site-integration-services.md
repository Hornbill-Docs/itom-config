...
- [How it works](/itom-config/configuration/site-integration-services#how-it-works)
- [Software updates](/itom-config/configuration/site-integration-services#software-updates)
- [Technical considerations](/itom-config/configuration/site-integration-services#technical-considerations)
- [Toolbar](/itom-config/configuration/site-integration-services#toolbar)
- [Service details](/itom-config/configuration/site-integration-services#service-details)
- [Creating an SIS profile on the Hornbill instance](/itom-config/configuration/site-integration-services#creating-an-sis-profile-on-the-hornbill-instance)
- [Downloading and installing the SIS](/itom-config/configuration/site-integration-services#downloading-and-installing-the-sis)
- [Pairing an SIS server with a Hornbill instance](/itom-config/configuration/site-integration-services#pairing-an-sis-server-with-a-hornbill-instance)
- [Grouping SIS servers](/itom-config/configuration/site-integration-services#grouping-sis-servers)
- [Creating a group](/itom-config/configuration/site-integration-services#creating-a-group)
- [Removing an SIS server installation](/itom-config/configuration/site-integration-services#removing-an-sis-server-installation)
